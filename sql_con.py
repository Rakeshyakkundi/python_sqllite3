...
i=0
while i != 999:
    num = int(input("\nEnter : 1]Add Student\t2]Delete Student\t 3]Search student\t 4]Print all Students details \t 5]Exit\n"))
    if num ==1:
        name = input("Enter student name :")
        USN = int(input('Enter your USN :'))
        m1 = int(input("Marks Subject one marks :"))
        m2 = int(input("Enter Subject two marks:"))
        m3 = int(input("Enter Subject three marks :"))
